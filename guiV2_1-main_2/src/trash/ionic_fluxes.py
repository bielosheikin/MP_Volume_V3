...
def J_cl_asor(n_potential_cl, g_asor, U, pH, Ar, pH_k2, pH_half, U_k2, U_half):
    return (
        n_potential_cl
        * g_asor
        * dep_funct.v_dependence_ASOR(U, U_k2, U_half)
        * dep_funct.pH_dependence_ASOR(pH, pH_k2, pH_half)
        * Ar
    )
...
def J_Cl_CLC(n_potential, g_clc, U, pH, Ar, pH_k2, pH_half, U_k2, U_half):
    return (
        ...
        * n_potential
        * g_clc
        * dep_funct.v_dependence_ClC(U, U_k2, U_half)
        * dep_funct.pH_dependence_ClC(pH, pH_k2, pH_half)
        * Ar
    )
