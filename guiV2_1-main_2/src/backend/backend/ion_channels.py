...
class IonChannel(Snapshotable):
    ...
    def get_free_hydrogen_concentrations(self,
        ...
        return flux_calculation_parameters.vesicle_hydrogene_free, flux_calculation_parameters.exterior_hydrogene_free
    ...
    def compute_log_term(self, 
        ...
        if (include_hydrogen and 
            flux_calculation_parameters.vesicle_hydrogene_free and 
            flux_calculation_parameters.exterior_hydrogene_free):
